...
echo "rm -rf $dist_dir"
rm -rf $dist_dir
echo "find $source_dir -iname "node_modules" -type d -exec rm -r "{}" \; 2"
find $source_dir -iname "node_modules" -type d -exec rm -r "{}" \; 2
echo "find $source_dir -iname "dist" -type d -exec rm -r "{}" \; 2"
find $source_dir -iname "dist" -type d -exec rm -r "{}" \; 2
echo "find $source_dir -iname "bower_components" -type d -exec rm -r "{}" \; 2"
find $source_dir -iname "bower_components" -type d -exec rm -r "{}" \; 2
